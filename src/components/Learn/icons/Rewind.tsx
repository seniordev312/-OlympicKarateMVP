...
export const Rewind: FC<IconProps> = ({width, height, fill}) => {
  ...
  return (
    <Svg
      ...
      />
      <Path
        d="M12 0L9 3l3 3V3.916a8.084 8.084 0 11-8.028 9.04C3.91 12.43 3.487 12 2.958 12c-.53 0-.963.43-.912.956A10 10 0 1012 2V0z"
        fill={fillState}
      />
    </Svg>
  );
